    ...
    const unsubscribe = onSnapshot(assocRef, (docSnap) => {
      if (docSnap.exists()) {
        ...
        setFormData(prev => ({
          ...
          siret: data.siret || data.rna || '',
          adresseSiegeSocial: data.adresseSiegeSocial || data.adresse || '',
          emailOfficiel: data.emailOfficiel || data.email || '',
          telephone: data.telephone || data.phone || '',
          clauseSpecifique: data.clauseSpecifique || data.legalClause || '',
          signaturePresidentUrl: data.signaturePresidentUrl || '',
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await setDoc(assocRef, {
        ...
        associationRules: formData.associationRules || '',
