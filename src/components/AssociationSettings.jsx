      ...
      <div className="flex flex-col gap-4 text-left select-none max-w-3xl mx-auto w-full">
        ...
        {loading ? (
          ...
          <div className="flex flex-col gap-3">
            ...
            {/* Permissions & Accès Section */}
            <CordelCard variant="default" useExtremeBorder={true} className="py-4 px-5">
              <h3 className="text-xs uppercase font-extrabold tracking-wider text-cordel-wood mb-3">
                🪢 Permissions & Accès (Matrice)
              </h3>
              <p className="text-[10px] text-cordel-master-dark/70 font-semibold leading-relaxed mb-3">
                Déléguez l'accès aux différentes sections administratives en cochant les étiquettes correspondantes.
              </p>

              {tagsDisponibles.length === 0 ? (
                <div className="text-[10px] italic text-red-700 bg-red-100/20 p-3 border border-dashed border-red-700/20 rounded">
                            ...
                            <input 
                              ...
                              onChange={(e) => {
                                ...
                                setPermissionsMatrice(prev => ({
                                  ...prev,
                                  troupe: checked ? [...(prev.troupe || []), tag] : (prev.troupe || []).filter(t => t !== tag)
                                }));
                              }}
                              disabled={saving}
                          ...
                          <label key={tag} className="flex items-center gap-1.5 cursor-pointer text-[10px] font-bold select-none hover:opacity-85">
                            <input 
                              ...
                              onChange={(e) => {
                                ...
                                setPermissionsMatrice(prev => ({
                                  ...prev,
                                  logistique: checked ? [...(prev.logistique || []), tag] : (prev.logistique || []).filter(t => t !== tag)
                                }));
                              }}
                              disabled={saving}
                              className="rounded cursor-pointer w-3.5 h-3.5"
                          ...
                          <label key={tag} className="flex items-center gap-1.5 cursor-pointer text-[10px] font-bold select-none hover:opacity-85">
                            <input 
                              ...
                              onChange={(e) => {
                                ...
                                setPermissionsMatrice(prev => ({
                                  ...prev,
                                  studio: checked ? [...(prev.studio || []), tag] : (prev.studio || []).filter(t => t !== tag)
                                }));
                              }}
                              disabled={saving}
                              className="rounded cursor-pointer w-3.5 h-3.5"
